...
struct TransactionDetailView: View {
    ...
    var body: some View {
        List {
            ...
            Section("Category") {
                ...
                if transaction.categorySource != .user {
                    Text("Correcting the category teaches Polaris — future \(transaction.normalizedDescription) charges will use your choice.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
            }
        ...
        // Corrections teach the AI — acknowledge them physically.
        .sensoryFeedback(.success, trigger: transaction.categoryRaw)
